...
//INSTANTIATE_TYPED_TEST_CASE_P(SeqToposort, LazyTest, P1);
//INSTANTIATE_TYPED_TEST_CASE_P(ParToposort, LazyTest, P2);
INSTANTIATE_TYPED_TEST_CASE_P(Pulsecount, LazyTest, P3);
INSTANTIATE_TYPED_TEST_CASE_P(Subtree, LazyTest, P4);
